...
function PerfilEmpresa() {
    ...
    function direcionarParaCadastroVaga() {
        window.location = "http://dev4me.ddns.net:3000/post-vaga";
    }
    ...
    return(
        <>
        <HeaderLogadoDois 
        encaminharTo="http://dev4me.ddns.net:3000/perfil-empresa"
        encaminharToFeed="http://dev4me.ddns.net:3000/feed-empresa"
        />
